        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="flex h-8 w-8 items-center justify-center rounded-full border border-slate-200 text-[11px] font-bold text-slate-500 transition hover:border-rose-300 hover:text-rose-500"
              >
                GH
              </a>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-xs text-slate-500">
              ...
              <li>
                <a href="#careers" className="transition hover:text-rose-500">
                  Careers
                </a>
              </li>
            </ul>
